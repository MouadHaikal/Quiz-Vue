<template>
    <div 
        class="w-[38rem] h-[38rem] mx-auto mt-16 bg-gray-800/20 backdrop-blur-md rounded-2xl shadow-gray-950 outline-2 outline-offset-8
        outline-dashed outline-gray-700 border border-gray-700 hover:bg-gray-950/5 hover:border-gray-600 hover:outline-gray-600
        transition duration-400 hover:shadow-lg relative
    ...
    >
        ...
        <form class="w-5/6 mx-auto" @submit.prevent="handleSubmission" ref="form">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="password" name="repeat_password" id="floating_repeat_password" 
                    class="block py-2.5 px-0 w-full text-lg bg-transparent border-0 border-b-2 appearance-none text-gray-200 
                    border-gray-600 focus:border-violet-400 focus:outline-none focus:ring-0 peer" 
                    placeholder=" " required ref="passwordConfInput" @blur="validatePasswordConf"
            ...
            <div class="mb-5 mt-7">
                ...
                <label for="check" class="text-gray-300 ml-2 select-none">
                    I agree with the <span class="font-bold text-violet-400 cursor-pointer">terms and conditions</span>
                </label>
            </div>
            ...
            <div class="w-full flex justify-center mt-9 text-gray-400 text-sm font-bold">
                <router-link :to="{ name:'Login' }" class="cursor-pointer hover:text-gray-300">
...
<script setup>
    ...
    import { registerUser,signInWithGoogle } from "../composables/useAuth.js";
    ...
    const form = ref(null);
    const passwordConfInput = ref(null);


    const validatePasswordConf = () => {
        if (password.value !== passwordConf.value) {
            passwordConfInput.value.setCustomValidity("Passwords do not match.");
            form.value.reportValidity();
        } else {
            passwordConfInput.value.setCustomValidity("");
        }
    }
